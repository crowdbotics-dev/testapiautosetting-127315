...
## Project Structure
    ...
    ├── testapiautosetting_127315  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127315`
...
2. Clone this repo and `cd testapiautosetting_127315`
